...
This file defines how payments, ownership, and rights to the work product are handled.

---

## 1. Payment Structure (50/50)
...
2. **Final Payment – 50%**
   ...
   - Unlocks:
     ...
     - License to use the landing page commercially

No work should be started before the deposit is paid.  
No final deliverables or deployment should occur before the final payment is received.
...
- All work product remains **your IP**, including:
  ...
  - Copy and messaging
  - Code and components
  - Any derivative assets created for the page
- The client is granted a **limited, preview-only license**:
  - They may view the draft privately for review and feedback
...
- You may retain:
  - The right to reuse underlying patterns, layouts, and non-client-specific structures in other projects
  - The right to keep anonymized examples for your portfolio (if agreed in advance)
...
This policy is meant to protect your time and IP while staying fair and clear to the client.