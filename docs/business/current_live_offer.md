...
## Offer Name (Internal and External)
...
- Copywriting:
  - Headlines, subheads, body copy, and CTA text for the page
- Implementation:
  - Page built in my landing page system (Ghost_factory stack)
- One revision round:
  - One focused round of changes based on consolidated feedback
  - Designed for polishing and aligning, not a full rebuild

Not included (by default):

- Full multi-page website
- Ongoing unlimited edits or content changes
- Complex funnel setups (multi-step forms, automations, etc.)
- Branding overhaul (logo design, full brand guide, etc.)
- Custom integrations beyond basic forms/links unless specifically scoped

---

## Turnaround Promise (Public) vs Internal Reality
...
- Use the remaining time window for:
  ...
  - Fixing any small layout/copy issues before the client sees it

---

## Pricing (Internal View Only)

Internal anchor:

- This offer = LP-Standard.

Internal target price range:
...
- 50/50 structure:
  - 50% deposit to start (and release the intake form link).
  - 50% on final approval before:
    - Connecting their domain (Managed Hosting), or
...
## Hosting Options (How This Offer Connects)
...
## Revision Policy (For This Offer)
...
- Client sends one consolidated list of changes.
- I apply those changes as long as they are:
  - Consistent with the original goal and intake,
  - Not a complete shift in audience, offer, or visual direction.

Out-of-scope changes (new offer, new audience, full redesign) should be:

- Treated as a new project or paid add-on, based on:
  - docs/revisions_and_refunds.md
  - docs/offer_scope.md

---

## Why Only One Live Offer for Now

Internal reasoning:

- Keeps my marketing simple:
  - One page to explain
  - One offer to sell
...
LP-Base and LP-Plus remain:

- Internal-only variants I can use when:
  - Scope is clearly smaller (LP-Base),
...
- Decide whether to:
  ...
  - Add branding starter packs as a second service.