...
**Core Promise:** Ultra-fresh, small-batch coffee delivered monthly, roasted weekly from direct-sourced farms. Every bag shows a roast date, and all subscriptions include free shipping.

**Primary Goal:** Drive subscription sign-ups
**Secondary Goal:** Generate one-time bag purchases
...
### Hero Section
- **Purpose:** Capture attention, communicate core value, drive immediate action
- **Content:** Headline emphasizing freshness + convenience; subhead with roast-date guarantee; lifestyle imagery of coffee ritual
- **Primary CTA:** "Start Your Subscription"
- **Tone:** Warm and inviting, not salesy

### Features / Benefits
- **Purpose:** Quickly communicate the three core differentiators
- **Content:** 
  - Weekly fresh roasts (roast date on every bag)
  - Direct-from-farm sourcing (Ethiopia, Colombia, Guatemala)
  - Free shipping on all subscriptions
- **Format:** Icon-driven cards or horizontal feature strip
...
- **CTA:** "Start Your Subscription" on each tier

### Press / Media Mentions
- **Purpose:** Third-party credibility
- **Content:** Portland Monthly, Willamette Week logos/quotes (pending assets)
- **Format:** Simple logo bar or short quote cards

### Testimonials
- **Purpose:** Social proof from real customers
- **Content:** Pending from client
- **Format:** Quote cards with names/photos if available

### FAQ
- **Purpose:** Overcome objections, reduce support inquiries
- **Content:** Address key concerns:
  - Pricing/value ("cheaper than your daily Starbucks")
  - Commitment fears ("pause or cancel anytime")
  - Quality guarantee ("first bag replaced free if you're not happy")
  - Shipping details (pending clarification)
- **Format:** Accordion or simple Q&A list

### Footer
- **Purpose:** Secondary conversion opportunity; trust signals
- **Content:** Satisfaction guarantee mention; secondary CTA; social links (@emberroasterspdx); basic legal
...
|------|--------|----------|
| Shopify checkout URL | Pending | High |
| Logo / brand assets | Pending | High |
| Exact hex color values | Pending | Medium |
| Customer testimonials | Pending | Medium |
| Press quotes (Portland Monthly, Willamette Week) | Pending | Medium |
| Shipping details (timeline, carriers) | Pending | Medium |
| Exclusive micro-lots info | Pending | Low |
| Product photography | Pending | High |
